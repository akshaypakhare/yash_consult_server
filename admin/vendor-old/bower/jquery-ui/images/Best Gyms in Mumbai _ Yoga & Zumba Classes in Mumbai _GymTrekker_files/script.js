...
(function ($) {
    ...
    $.fn.btParallax = function (options) {
        $(this).each(function () {
            ...
            this.background = adv.find('.howit-img');
            this.background_img = adv.find('.howit-img img');
            ...
            this.openParallaxContent = function (e) {
                ...
                adv.find('.howit-img').addClass('in-parallax');
                ...
                btParallax.back_posY = adv.find('.howit-img').position().top;
                btParallax.back_posX = adv.find('.howit-img').position().left;
                if (options.slideSize.type === 'full') {
                    var cssOpen = {
                        'position': 'fixed',
                        'z-index': 99999,
                ...
                adv.css(cssOpen).animate({'top': btParallax.eTopCenter},
                {
                    ...
                    step: function (now, fx) {
                        ...
                        adv.find('.howit-img').css({left: btParallax.back_posX + 'px', top: walk + 'px'});
                    },
                    done: function () {
                        setTimeout(function () {
            ...
            this.parallaxContentZoomOutWidth = function (callback) {
                adv.animate({'left': (btParallax.win_width - btParallax.para_width) / 2, 'width': btParallax.para_width},
                {
                    duration: 500,
                    step: function (now, fx) {
                        adv.find('.howit-img').css({left: btParallax.back_posX + 'px', top: '0px'});
                    },
                    done: function () {
                        callback;
                    }
                    ...
                    setTimeout(function () {
                        ...
                        adv.animate({'top': btParallax.eTopCurrent, 'left': eleftC},
                        {
                            ...
                            step: function (now, fx) {
								...
								adv.find('.howit-img').removeClass('in-parallax');

...
<div class="uploadcv-index">
    ...
    <p>
        ...
        <?= Html::a('Download All Resumes',['test'],['class' => 'btn btn-primary']) ?>
    </p>
        ...
        'columns' => [
            ...
            /*
             [
                   ...
                   //'filter'=>array("0"=>"Website","1"=>"Backend"),
                   'value' => function ($model) {
                                $test = Html::a('*Download CV', ['/uploadcv/download', 'id' => $model->id], ['class'=>'btn btn-primary']);
                                 return (!empty($model->cvpath))? $test:'Not Available';
                             },
            ], */
            [
                'attribute' => 'cvpath',
                ...
                'contentOptions' => function ($model) {
                    return ['style' => 'background-color:' . (!empty($model->cvpath) ? 'Chartreuse' : 'yellow')];
                },
            ],
                        'created_by',
            'created_at',

...
class UploadcvController extends Controller
{
        ...
        return [
            'access' => [
                    ...
                    'rules' => [
                        ...
                        [
                            'actions' => ['logout', 'index', 'view', 'delete', 'create', 'update', 'download', 'zip-download' ],
                            'allow' => true,
                            'roles' => ['@'],
                        ],
                    ],
    ...
    public function actionUpdate($id)
   {
    ...
    //Action to down all resumes in zip format
    public function actionZipDownload()
    {
                ...
                $zip = new \ZipArchive();
                $zip->open('../web/yc-resumes.zip', \ZipArchive::CREATE );
